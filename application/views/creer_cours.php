...
.bg-light {
    ...
    ?>
    	<h4>nom du cours</h4>
		<br> <input type="text" id="nom_cours" name="nom_cours" />


		<h4>Documents du cours</h4>
		<br> <input type="file" id="id" name="files[]" multiple="multiple" /><br>
		<br> <input type="submit" name="creer" value="creer le cours" /><br>
		<br>
    <?php
    echo form_close();
    ?>
