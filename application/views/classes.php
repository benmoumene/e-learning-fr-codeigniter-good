    	...
    	<div class="list-group mt-4">
    	  ...
    	  <?php foreach($classeList as $classe) :?>
            ...
            <?php echo form_open("/ClassesController/removeClasse");?>
               	<button class="btn btn-danger mt-2 col-md-4 col-sm-2" onclick="return confirm('Etes vous sur de vouloir supprimer cette classe?')"><i class="fa fa-trash" style="font-size:30px;"></i> Supprimer le classe</button>
