 ...
 */
class Classe extends \Classe implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Classe' . "\0" . 'id', '' . "\0" . 'Classe' . "\0" . 'nom', '' . "\0" . 'Classe' . "\0" . 'etudiants', '' . "\0" . 'Classe' . "\0" . 'cours', '' . "\0" . 'Classe' . "\0" . 'quizzes'];
        }
    ...
    public function setEtudiants($etudiants)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEtudiants', [$etudiants]);
    ...
    public function setQuizzes($quizzes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setQuizzes', [$quizzes]);
