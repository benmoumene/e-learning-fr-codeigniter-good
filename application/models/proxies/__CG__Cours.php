 ...
 */
class Cours extends \Cours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cours' . "\0" . 'id', '' . "\0" . 'Cours' . "\0" . 'intitule', '' . "\0" . 'Cours' . "\0" . 'description', '' . "\0" . 'Cours' . "\0" . 'status', '' . "\0" . 'Cours' . "\0" . 'documents', '' . "\0" . 'Cours' . "\0" . 'classes'];
        }
